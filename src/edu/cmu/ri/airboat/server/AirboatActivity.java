...
public class AirboatActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        final Button DemoCode = (Button)findViewById(R.id.DemoCode);
        DemoCode.setOnClickListener(new OnClickListener() {
    		public void onClick(View v) {
    			// Start up the debug control activity
    			startActivity(new Intent(AirboatActivity.this, DemoCodeActivity.class));
    		}
    	});
